// Example code for Linked List in C#
namespace classes{
    public class Linkedlist{
        ...
        public LinkedList<int> AddNumberToLast(LinkedList<int> list, int number){
            list.AddLast(number);
            return list;
        }

        public LinkedList<int> AddNumberToFirst(LinkedList<int> list, int number){
